...
sent_dict = {'CMCSA':"Comcast Corporation was chosen because it is one of the largest entertainment companies in the world, and is also one of the largest providers in TV and is the largest ISP in the US. It’s also experienced some extreme volatility this current year, as it has hit both a record high price this year and is also at a lower price than where it started year to date. Lastly, since our machine learning was using closing prices, the extreme volatility in both upward and downward pricing made it more difficult in making an accurate prediction.", 
'V':'Visa is one of the largest multinational financial services in the world and is the second largest card payment organization in the world. It is also one of the 30 companies that the Dow Jones Industrial Average tracks, and has been consistently exceeding expectations in its reported quarterly earnings. Even though Visa currently is trending downward, it’s only trending negatively in the short-term, over the year it has grown tremendously and has only been trending upward since its inception. Lastly, because there is lower volatility in the closing prices, it may have been one of the reasons why our machine learning could score a relatively high accurate score.', 
