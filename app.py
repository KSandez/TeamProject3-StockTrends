...
future = int(30)
# identify the stocks
tickers = ['DIS','CMCSA', 'V', 'LMT', 'NVDA', 'FB', 'NFLX', 'FOX', 'ORCL', 'TSLA', 'BA']
names_dict = {'DIS':'Disney','CMCSA':'Comcast', 'V':'Visa', 'LMT':'Lockheed Martin', 'NVDA':'Nivdia', 'FB':'Facebook', 'NFLX':'Netflix', 'FOX':'21st Century Fox', 'ORCL':'Oracle', 'TSLA':'Tesla', 'BA':'Boeing'}
sent_dict = {'DIS': "The Walt Disney Company founded in 1923 is to be one of the world’s leading producers and providers of entertainment and information. With a divsified ortfolio of brands to differentiate content, services and consumer products, to develop the most creative, innovative and profitable entertainment experiences and related products in the world.",
'CMCSA':"Comcast is the world's largest broadcasting and cable corporation. Comcast is the largest cable television and internet provider services. The company began in 1963 in Tupelo, Mississippi and went public in 1972 with an initial price of $7 per share. Comcast's stock price has risen steadily since it was initially offered and peaked for $42 a share in February 2018.", 
